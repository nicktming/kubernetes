...
import (
	...
	//"k8s.io/kubernetes/pkg/kubelet-new/checkpoint"
	//"k8s.io/kubernetes/pkg/kubelet-new/checkpointmanager"
	//"k8s.io/kubernetes/pkg/kubelet-new/configmap"
	kubecontainer "k8s.io/kubernetes/pkg/kubelet-new/container"
	//"k8s.io/kubernetes/pkg/kubelet-new/secret"
