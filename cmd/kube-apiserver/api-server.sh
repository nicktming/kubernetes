...
config="$config --tls-private-file=/root/ssl_keys/server.key"
...
config="$config --admission_controller=NamespaceLifecycle,LimitRanger,ServiceAccount,DefaultStorageClass,ResourceQuota,MutatingAdmissionWebhook,ValidatingAdmissionWebhook"
